...
export function HeroSection({
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-effuse-slate via-effuse-medium-grey to-effuse-teal">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-effuse-off-black/50 to-transparent z-10" />
      ...
      >
        ...
        >
          <AnimatedItem animation="reveal" delay={0.7} duration={1.5}>
            <H1 className="text-effuse-white text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6 tracking-tight font-inter">
              {title}
            </H1>
          </AnimatedItem>
          <AnimatedItem animation="slideUp" delay={1.0} duration={1.2}>
            <Text className="font-inter font-normal text-xl sm:text-2xl lg:text-2xl text-effuse-white/80 max-w-2xl leading-relaxed mb-10">
              {description}
            </Text>
          </AnimatedItem>
